...
layer: "L1: 60%, L2: 40%"
concepts:
  - Services as request/response communication
...
**What to notice**: The AI explains that topics are better for continuous control (topic fires repeatedly, service would block). This teaches design reasoning.
