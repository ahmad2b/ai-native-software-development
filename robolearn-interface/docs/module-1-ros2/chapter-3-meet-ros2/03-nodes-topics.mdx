...
concepts:
  ...
  - Topics as named message channels
learning_objectives:
...
**What to notice**: The AI explains loose coupling, extensibility, and testability. This prepares you for Chapter 4 when you write your own nodes.
...
**Next lesson**: [→ Lesson 3.4: Services and Parameters (CLI Exploration)](./04-services-parameters.mdx)
