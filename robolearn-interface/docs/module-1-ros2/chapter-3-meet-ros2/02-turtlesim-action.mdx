...
layer: "L1: 60%, L2: 40%"
concepts:
  - ROS 2 nodes and launching applications
  - Interactive visualization and keyboard control
learning_objectives:
...
**What to notice**: The AI explains the **publish/subscribe pattern** and why it's better than direct function calls. This mental model is crucial for Chapter 4 when you write your own nodes.
...
**Next lesson**: [→ Lesson 3.3: Nodes and Topics (CLI Exploration)](./03-nodes-topics.mdx)
