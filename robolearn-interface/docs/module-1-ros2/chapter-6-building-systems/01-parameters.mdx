...
layer_breakdown: { L1: 30, L2: 50, L3: 20 }
cognitive_load:
  new_concepts: 2
  estimated_time_minutes: 60
skills_required:
  - "ros2-publisher-subscriber"
tags: ["ROS 2", "Parameters", "Configuration", "Runtime-Modification"]
---
...
**Key insight**: Parameters configure **values**, not **types**. For structural changes (message types, service definitions), you create different nodes or design polymorphic message types. In this discussion, AI learned about production flexibility constraints while you learned about the boundaries of parameter-based configuration.
