...
layer_breakdown: { L1: 30, L2: 40, L3: 20, L4: 10 }
cognitive_load:
  new_concepts: 2
...
tags: ["ROS 2", "Debugging", "Diagnostics", "Troubleshooting"]
---
...
```mermaid
graph TD
    A["System Not Working?"] --> B["Run ros2doctor"]
    B --> C{"Health Check<br/>Passed?"}
    C -->|No| D["Fix Environment<br/>Issues"]
    C -->|Yes| E["Open rqt_graph"]
    E --> F{"Graph<br/>Correct?"}
    F -->|No| G["Check Node<br/>Names & Topics"]
    F -->|Yes| H["Enable DEBUG<br/>Logging"]
    H --> I["Echo Topics<br/>Check Data Flow"]
    I --> J{"Data<br/>Flowing?"}
    J -->|No| K["Debug Individual<br/>Node"]
    J -->|Yes| L["System<br/>Working!"]
    G --> K
    D --> L
```
