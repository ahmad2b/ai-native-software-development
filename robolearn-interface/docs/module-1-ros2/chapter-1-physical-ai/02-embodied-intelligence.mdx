...
```mermaid
graph TB
    subgraph Sensorimotor["The Sensorimotor Loop"]
        D["Decision<br/>What to do"]
        C["Command<br/>Send to motor"]
        M["Motor Acts<br/>Joint moves"]
        S["Sensory Feedback<br/>Proprioceptors, IMU"]
        U["Update Model<br/>What actually happened"]
        D --> C --> M --> S --> U --> |"Refine next<br/>decision"| D
        style M fill:#ffecb3
        style S fill:#c8e6c9
    end
```
...
**Previous:** [Lesson 1.1: Digital to Physical →](./01-digital-to-physical.mdx) | **Next:** [Lesson 1.3: The Humanoid Revolution →](./03-humanoid-revolution.mdx)
