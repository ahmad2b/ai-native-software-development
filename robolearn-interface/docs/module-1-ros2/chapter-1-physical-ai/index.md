...
description: "Introduce embodied intelligence, physical constraints, and the humanoid robotics ecosystem"
---
...
**Next Chapter**: [Chapter 2: The Robot System →](../chapter-2-robot-system/index.md)

**Module Overview**: [← Back to Module 1](../index.md)

**Start Lesson 1.1**: [From ChatGPT to Walking Robots →](./01-digital-to-physical.mdx)
