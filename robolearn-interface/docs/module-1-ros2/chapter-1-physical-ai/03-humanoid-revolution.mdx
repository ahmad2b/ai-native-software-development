...
```mermaid
timeline
    title Humanoid Robotics Timeline (2000-2025)
...
graph TB
    subgraph Research["RESEARCH & DEVELOPMENT"]
        BD["Boston Dynamics<br/>Atlas, Spot"]
        UT["Unitree H1<br/>Humanoid Research"]
    end

    subgraph Industry["INDUSTRIAL DEPLOYMENT"]
        Tesla["Tesla Bot<br/>Manufacturing"]
        Figure["Figure AI<br/>General Purpose"]
        Agility["Agility Robotics<br/>Warehouse"]
    end

    subgraph Consumer["CONSUMER & EDUCATION"]
        Go2["Unitree Go2<br/>$3-5K"]
        OpenSource["DIY Robotics<br/>ROS 2 + Custom"]
    end

    subgraph Learning["YOUR LEARNING PATH"]
        Tier1["Tier 1: Simulation<br/>ROS 2 in cloud"]
        Tier2["Tier 2: Local GPU<br/>Isaac Sim / Gazebo"]
        Tier3["Tier 3: Edge Hardware<br/>Jetson + sensors"]
        Tier4["Tier 4: Physical Robot<br/>Go2 or custom"]
    end
...
**Previous:** [Lesson 1.2: Embodied Intelligence →](./02-embodied-intelligence.mdx) | **Next:** [Chapter 2 →](../chapter-2-robot-system/index.mdx)
