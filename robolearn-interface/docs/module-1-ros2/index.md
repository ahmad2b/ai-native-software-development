...
[→ Start Chapter 1](./chapter-1-physical-ai/index.md)
...
[→ Start Chapter 2](./chapter-2-robot-system/index.md)
...
[→ Start Chapter 3](./chapter-3-meet-ros2/index.md)
...
[→ Start Chapter 4](./chapter-4-first-code/index.md)
...
[→ Start Chapter 5](./chapter-5-communication/index.md)
...
[→ Start Chapter 6](./chapter-6-building-systems/index.md)
...
[→ Start Chapter 7](./chapter-7-capstone/index.md)
...
| **L2: AI Collaboration** | You work with AI as Teacher, Student, Co-Worker simultaneously | Prompt, validate, iterate | 3-5 |
...
```mermaid
graph TB
    subgraph "Chapter 1-2: Foundation (L1)"
        A["Ch1: Physical AI<br/>Concepts"]
        B["Ch2: Robot System<br/>Sensors, Actuators, Middleware"]
    end

    subgraph "Chapter 3: Bridge (L1→L2)"
        C["Ch3: Meet ROS 2<br/>CLI Exploration"]
    end

    subgraph "Chapter 4-5: Hands-On (L2+L3)"
        D["Ch4: First Code<br/>Pub/Sub"]
        E["Ch5: Communication<br/>Services + Interfaces"]
    end

    subgraph "Chapter 6: Integration (L3)"
        F["Ch6: Building Systems<br/>Launch + Debug"]
    end

    subgraph "Chapter 7: Capstone (L4)"
        G["Ch7: Multi-Node<br/>Spec-Driven"]
    end
...
- **Blue**: L1 Manual Foundation
- **Orange**: L1→L2 Transition
- **Purple**: L2 AI Collaboration + L3 Intelligence Design
- **Green**: L3 System Integration
- **Amber**: L4 Spec-Driven Capstone
...
**Ready to begin?** [Start Chapter 1: What is Physical AI?](./chapter-1-physical-ai/index.md)
