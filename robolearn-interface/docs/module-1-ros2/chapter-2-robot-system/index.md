...
**Previous Chapter**: [← Chapter 1: Physical AI](../chapter-1-physical-ai/index.md)

**Next Chapter**: [Chapter 3: Meet ROS 2 →](../chapter-3-meet-ros2/index.md)

**Module Overview**: [← Back to Module 1](../index.md)

**Start Lesson 2.1**: [How Robots See →](./01-how-robots-see.mdx)
