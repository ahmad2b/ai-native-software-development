...
This is AI as Teacher — suggesting patterns from thousands of ROS 2 projects you haven't seen.
...
**What happened:**
- AI learned your constraint (10 messages/second max)
- AI refined its suggestion (made it configurable)
- You now control rate at runtime without recompiling

This is AI as Student — learning from your feedback and adapting.
...
This is AI as Co-Worker — iterating toward a solution better than either could create alone.

---

## The Three Collaboration Patterns (Invisible to You)

Notice what just happened:
1. **AI taught you** (suggesting production patterns you didn't know)
2. **You taught AI** (refining with your bandwidth constraint)
3. **You converged** (iterating toward an abstraction that serves both needs)

These are the Three Roles — but you never saw those labels in the lesson. You experienced them through action and dialogue.
...
**In this lesson, you:**
- Worked with AI to improve code (AI as Teacher)
- Guided AI with constraints (AI as Student)
- Iterated toward better designs (AI as Co-Worker)
...
In this lesson, you experienced AI collaboration:
- AI suggests patterns (you didn't know about production-readiness)
- You provide constraints (bandwidth, message types, deployment platforms)
- You iterate together (improve the design collaboratively)

The Three Roles pattern is invisible — you never saw those labels. You just experienced natural dialogue between human expertise and AI expertise converging toward better solutions.

This is the foundation for everything in Modules 2-4, where systems become more complex and AI collaboration becomes more valuable.

**Next: Chapter 5 — Communication Mastery**

You've mastered pub/sub. In Chapter 5, you'll learn services (request/response), custom message types, and design patterns for choosing between topics and services. You'll apply the same Three Roles pattern to more sophisticated communication systems.
