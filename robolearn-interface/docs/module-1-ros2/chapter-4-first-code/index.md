...
Collaborate with AI to extend your pub/sub system. Ask AI to help add error handling, configuration, logging levels. Experience the Three Roles of AI collaboration (Teacher, Student, Co-Worker) without the framework being exposed.

**Core Concepts**:
- AI-assisted code generation (AI as Teacher)
- Validating AI suggestions (you as Student)
- Iterating toward better design (both as Co-Workers)
...
**Previous Chapter**: [← Chapter 3: Meet ROS 2](../chapter-3-meet-ros2/index.md)

**Next Chapter**: [Chapter 5: Communication Mastery →](../chapter-5-communication/index.md)

**Module Overview**: [← Back to Module 1](../index.md)

**Start Lesson 4.1**: [Workspaces and Packages →](./01-workspaces-packages.mdx)
