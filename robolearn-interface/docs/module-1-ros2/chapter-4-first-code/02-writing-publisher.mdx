...
This is AI as Teacher (suggesting patterns you didn't know), AI as Student (learning your constraints), and AI as Co-Worker (iterating toward the best solution).
...
You've written your first ROS 2 node — a publisher:
- Node class inherits from Node
- Timer callback runs periodically
- Publisher.publish() sends messages
- rclpy.spin() runs the node forever
