...
You've written your first subscriber:
- `create_subscription()` listens to a topic
- Callback is called automatically when messages arrive
- Multiple subscribers can listen to the same topic
- The publisher doesn't know or care about subscribers

You now understand the pub/sub pattern — the core communication mechanism in ROS 2. In the next lesson, you'll combine everything you've learned with AI collaboration to build more sophisticated systems.
