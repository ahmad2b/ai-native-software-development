...
![Architecture diagram showing Manager Agent orchestrating multiple Worker Agents through contract-based coordination with shared specification as source of truth](/img/part-6/chapter-35/orchestration-architecture.png)
