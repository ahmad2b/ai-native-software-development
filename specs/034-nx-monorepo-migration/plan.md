...
- `pnpm-workspace.yaml` - Package manager workspace definition (apps/*, libs/**/*, packages/*, tools/*)
...
- Integration: Verify `Read book-source/docs/chapter-index.md` resolves correctly
...
2. Read `book-source/docs/chapter-index.md` → resolves via symlink
3. Create new lesson in `book-source/docs/test-part/test-chapter/lesson.md`
