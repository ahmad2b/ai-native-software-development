...
- [ ] **MUST**: Technical reviewer validation
  - **Description**: Invoke `technical-reviewer` subagent for constitutional alignment check
...
|-------|------|----------|-------|-----------|
| **1** | Lesson outlines | 4 hours | lesson-writer | Structures approved |
| **1** | Content writing (all 6 lessons) | 31-33 hours | lesson-writer | All content drafted |
| **1** | "Try With AI" design (24 prompts) | 6-8 hours | lesson-writer | All prompts designed |
| **2** | Example verification | 1.5 hours | lesson-writer | 100% verified |
| **2** | Sandbox CLI testing | 1.5 hours | human | All commands work |
| **2** | "Try With AI" testing | 2-3 hours | lesson-writer | All prompts achievable |
| **2** | Cognitive load validation | 1.5 hours | lesson-writer | ≤7 concepts validated |
| **2** | Evals verification | 2.5 hours | lesson-writer | All evals achievable |
| **3** | Technical review | 1.5 hours | technical-reviewer | Constitutional PASS |
| **3** | Proof validation | 1 hour | proof-validator | Quality gates PASS |
...
1. **Assign Owner**: Identify lesson-writer subagent or human author
