...
**Subagents Required**:
- `lesson-writer` - Execute content revision
- `technical-reviewer` - Validate constitutional alignment
...
**Phase 4: Validation**
- Time: 2-3 hours
- Agents: `technical-reviewer`, `proof-validator`
...
2. **Phase 3: Implementation** (invoke `lesson-writer` subagent)
