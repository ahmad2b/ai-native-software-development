...
- [ ] Constitutional alignment: PASS (technical-reviewer validation)
...
| **Implement** | Write all 6 lessons + Try With AI | 6-8 hours | lesson-writer |
| **Content Verification** | Cross-check against verified cache | 1 hour | lesson-writer |
| **Technical Review** | Constitutional alignment + code | 1.5 hours | technical-reviewer |
| **Sandbox Testing** | Install CLI, run all commands | 1.5 hours | human |
| **Validation Report** | Final quality gate | 1 hour | proof-validator |
...
1. **Phase 3: Implementation** → Invoke `lesson-writer` subagent
