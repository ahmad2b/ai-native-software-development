...
class TestReadContentOverlay:
    ...
    @pytest.mark.asyncio
    async def test_read_from_base_when_no_user_id(self, setup_fs_backend):
    ...
    @pytest.mark.asyncio
    async def test_read_from_overlay_when_exists(self, setup_fs_backend):
    ...
    @pytest.mark.asyncio
    async def test_read_falls_back_to_base_when_no_overlay(self, setup_fs_backend):
    ...
    @pytest.mark.asyncio
    async def test_read_returns_error_when_neither_exists(self, setup_fs_backend):
...
class TestWriteContentOverlay:
    ...
    @pytest.mark.asyncio
    async def test_write_to_base_when_no_user_id(self, setup_fs_backend):
        ...
        result = await write_content(params)
        data = json.loads(result)
    ...
    @pytest.mark.asyncio
    async def test_write_to_overlay_when_user_id_provided(self, setup_fs_backend):
    ...
    @pytest.mark.asyncio
    async def test_overlay_write_does_not_modify_base(self, setup_fs_backend):
    ...
    @pytest.mark.asyncio
    async def test_overlay_update_requires_hash(self, setup_fs_backend):
...
class TestDeleteContentOverlay:
    ...
    @pytest.mark.asyncio
    async def test_delete_base_when_no_user_id(self, setup_fs_backend):
        ...
        result = await delete_content(params)
        data = json.loads(result)
    ...
    @pytest.mark.asyncio
    async def test_delete_overlay_only_when_user_id_provided(self, setup_fs_backend):
    ...
    @pytest.mark.asyncio
    async def test_delete_overlay_idempotent(self, setup_fs_backend):
    ...
    @pytest.mark.asyncio
    async def test_delete_overlay_resets_to_base(self, setup_fs_backend):
        ...
        result1 = await read_content(read_params)
        ...
        result2 = await read_content(read_params)
...
class TestOverlayIsolation:
    ...
    @pytest.mark.asyncio
    async def test_different_users_have_separate_overlays(self, setup_fs_backend):
        ...
        await write_content(alice_params)
        ...
        result_bob = await read_content(bob_read)
        ...
        result_base = await read_content(base_read)
        data_base = json.loads(result_base)
        assert "# Base Content" in data_base["content"]

    @pytest.mark.asyncio
    async def test_delete_one_user_overlay_preserves_others(self, setup_fs_backend):
