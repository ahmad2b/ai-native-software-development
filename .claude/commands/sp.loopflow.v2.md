...
**WHY THIS MATTERS**: Format drift in educational content creates inconsistent student learning. Chapter N originally used wrong skill format because this check wasn't performed.
...
Canonical sources:
  - Skills: Chapter N Lesson 7 (.claude/skills/<name>/SKILL.md)
